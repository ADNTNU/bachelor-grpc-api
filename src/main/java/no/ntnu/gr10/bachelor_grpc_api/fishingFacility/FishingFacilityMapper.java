...
public class FishingFacilityMapper {
  ...
  public static ResponseFishingFacility.Builder toProtoBuilder(FishingFacility entity) {
    ...
    if (entity.getVesselPhone() != null)       b.setVesselPhone(entity.getVesselPhone());
    if (entity.getToolTypeCode() != null)      b.setToolTypeCode(entity.getToolTypeCode());
    if (entity.getIrcs() != null)              b.setIrcs(entity.getIrcs());
    if (entity.getMmsi() != null)              b.setMmsi(entity.getMmsi());
    if (entity.getImo() != null)               b.setImo(entity.getImo());
    if (entity.getVesselEmail() != null)       b.setVesselEmail(entity.getVesselEmail());
    if (entity.getToolTypeName() != null)      b.setToolTypeName(entity.getToolTypeName());
    if (entity.getToolColor() != null)         b.setToolColor(entity.getToolColor());
    if (entity.getSource() != null)            b.setSource(entity.getSource());
    if (entity.getComment() != null)           b.setComment(entity.getComment());
    if (entity.getLastChangedBySource() != null) b.setLastChangedBySource(entity.getLastChangedBySource());
